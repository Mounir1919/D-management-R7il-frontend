                  ...
                  <td class="text-end pe-3">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" :href="`/edit_reservation_client/${res.id}`">Voir</a></li>
...
onMounted(async () => {
  try {
    ...
    const res = await axios.get('/transporteur/reservations-from-notifications', {
      headers: {
...
function deleteReservation(id) {
  if (confirm('Confirmer la suppression ?')) {
    axios.delete(`/delete/notifications/${id}`)
      .then(() => {
